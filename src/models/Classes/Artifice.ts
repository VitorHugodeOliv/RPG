...
export class Artifice extends Personagem {
  ...
  constructor(id: string, nome: string, nivel: number = 1, raca: Raca, subRaca: SubRaca, atributosEscolhidos: Atributos, classe: string, periciasSelecionadas: string[]) {
    const periciasIniciais = aplicarPericiasSelecionadas(periciasSelecionadas, 'Artifice');
    super(id, nome, nivel, raca, subRaca, atributosEscolhidos, classe = 'Artifice', periciasIniciais);
